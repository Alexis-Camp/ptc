      ...
      <form class="login100-form validate-form" action="<?php $_SERVER["PHP_SELF"]; ?>" method="post">
       ...
       <!-- <?php //echo display_msg($msg); ?>-->
        <div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type user name">
          <input id="first-name" class="input100" pattern="[a-zA-Z]+" type="text" name="full-name" placeholder="Nombre completo">
        ...
        <div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Type password">
          <input class="input100" type="password" minlength="8" name ="password" placeholder="Contraseña">
          <span class="focus-input100"></span>
        </div>

        <div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Type password">
          <input class="input100" type="password" minlength="8" name ="cpassword" placeholder="Confirmar contraseña">
          <span class="focus-input100"></span>
        </div>
